...
<!--========================================================================== Intro and FlexSlider =====================================================================================-->    
	...
	<div class="grid-16 grid grey">
		<h2>Please Enter your User Name and Registered Email..</h2>
	...
	<div class="container">
	<section id="content">
		<form action="forgot_passvali.php" method="post">
			<h1>Forgot Password Form</h1>
			<div>
				<input type="text" placeholder="Username" name="un"required="required" id="username" />
			</div>
			<div>
				<input type="text" placeholder="Email" name="em" required="required" id="username" />
			</div>
			<div>
