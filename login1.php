...
<div class="container">
	<section id="content">
		<form action="login_validate1.php" method="post">
			<h1>Login Form</h1>
			<div>
				<input type="text" placeholder="Username" name="un"required="required" id="username" />
			</div>
			<div>
				<input type="password" placeholder="Password" name="ps" required="required" id="password" />
			</div>
			<div>
				<input type="submit" value="Log in" />
				<a href="forgot_password.php">Forgot your password?</a>
				<a href="register_form_shpping.php">Register</a>
			</div>
		</form><!-- form -->
