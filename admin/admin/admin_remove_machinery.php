...
$rmp=$_POST['rm_product'];
$qw1=mysql_query("select * FROM products WHERE product_code='$rmp'");
$count=mysql_num_rows($qw1);
if ($count==1) {
	
	
$q30=mysql_query("DELETE FROM products WHERE product_code='$rmp' AND category='Machinery'");
$q31=mysql_query("DELETE FROM mach_spec WHERE product_code='$rmp'");
$q32=mysql_query("DELETE FROM stock_table WHERE product_code='$rmp' AND category='Machinery'");
