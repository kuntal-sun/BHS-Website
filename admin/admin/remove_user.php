...
<!--========================================================================== Intro and FlexSlider =====================================================================================-->    
	...
	<div class="wrapper">
		<?php
		$urnm=$_POST['urname'];
		$qxx=mysql_query("DELETE FROM registered_users WHERE user_name='$urnm'");
		echo '<p class="message success">User Removed Successfully </p>';
		
	   ?>
	   <div class="grid-16 grid green">
		<form action="user_info.php">
    	    <input type="submit"  value="Back to User Info">
    	   </form>
		</div>
