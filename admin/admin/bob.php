...
$qu1=mysql_query("SELECT * FROM datewise_catagory_sellingprice WHERE date='$edate'");
$count44=mysql_num_rows($qu1);

if ($count44==1) {
	echo'<div class="grid-16 grid grey">';
		echo'<h2>Daily Sales in INR</h2>';	
echo'</div>';
echo'<div class="grid-16 grid">';
	echo '<table border="1">';
	
	while ($r44=mysql_fetch_array($qu1)) {
