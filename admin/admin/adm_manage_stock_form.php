...
<!--========================================================================== Intro and FlexSlider =====================================================================================-->    
	...
	<div class="wrapper">
		...
		<h1 style="text-align: center;text-decoration: underline;color: blue">::ADMIN ADD STOCK::</h1></div>
		<div class="grid-8 grid green"><form name="add_stock" action="admin_add_stock.php" method="post">
		<label for="st_cat">Select a Category::</label>
	 <select name="st_category" required="required">
    ...
    <label for="st_procd">Enter A Existing Product Code::</label>
    <input type="text" name="st_pc" required="required"><br><br><br>
    
    <label for="st_q">Add Quantity</label>
    <input type="text" name="st_qty" required="required" >
    <input type="submit" value="Add Stock">
     <input type="reset" value="Reset">
     </form>
     </div>
     <div class="grid-6 grid">
     	<form action="adm_manage_stock_page.php">
    	 <input type="submit"  value="Back to Manage Stock">
    	   </form>
     </div>
