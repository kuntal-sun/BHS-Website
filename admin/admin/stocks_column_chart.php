		<?php include'config_bhsdb.php'; 


$ct12=$_POST['category'];


$q12=mysql_query("select * from stock_table where category='$ct12'");
$count=mysql_num_rows($q12);
if($count>=1){
$a12[]="['model_no','no_of_stocks']";
...
<!--========================================================================== Intro and FlexSlider =====================================================================================-->    
    ...
    <div class="grid-5 grid green"><h5>Category :<?php echo $ct12;?></h5><br><br></div>

    	<form action="adm_stock_chart_form.php">
    		<input type="submit"  value="Back to View Stock Chart">
    	</form>
