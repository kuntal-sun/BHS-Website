...
<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
	<tr>
	<th>News Heading</th>
	<td><textarea id="description" name="head" rows="8" cols="60" required="required" placeholder="Please write your heading here."></textarea></td>
	</tr>
	<tr>
	<th>News Description</th>
	<td><textarea id="description" name="desc" rows="8" cols="60" required="required" placeholder="Please write your news description here."></textarea></td>
...
<?php
               ...
               if(isset($_POST['submit'])){
               	$hd1=$_POST['head'];
				$hd2=$_POST['desc'];
				$qt=mysql_query("INSERT INTO news (heading,news) VALUES ('$hd1','$hd2')");
				echo'<div class="grid-6 grid">';
               echo'<p class="message success">News section successfully updated..</p>';
			   echo'</div>';
			   }
?>
