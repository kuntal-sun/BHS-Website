...
$mpc1=$_SESSION['pcode'];
$md3=$_POST['model_name'];
$br=$_POST['bore'];
$thckness=$_POST['thickness'];
$mp12=$_POST['max_pres'];
$brd=$_POST['b_rad'];
$mtsp=$_POST['max_temp'];


$q55=mysql_query("INSERT INTO suc_pipe(product_code,model_name,bore,thickness,max_pres,b_rad,max_temp) VALUES('$mpc1','$md3','$br','$thckness','$mp12','$brd', '$mtsp')");
	echo '<p class="message success">specification submitted successfully..</p>';
