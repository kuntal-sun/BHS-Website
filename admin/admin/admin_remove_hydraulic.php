...
$rhr=$_POST['rhr_product']; 
$qw3=mysql_query("select * FROM products WHERE product_code='$rhr'");
$count=mysql_num_rows($qw3);
if ($count==1) {



$q39=mysql_query("DELETE FROM products WHERE product_code='$rhr' AND category='HYDRAULIC RAMS'");
$q40=mysql_query("DELETE FROM hydraulic WHERE product_code='$rhr'");
$q41=mysql_query("DELETE FROM stock_table WHERE product_code='$rhr' AND category='HYDRAULIC RAMS'");
