...
$rspu=$_POST['rspu_product'];
$qw5=mysql_query("select * FROM products WHERE product_code='$rspu'");
$count=mysql_num_rows($qw5);
if ($count==1) {

$q36=mysql_query("DELETE FROM products WHERE product_code='$rspu' AND category='Suction Pumps'");
$q37=mysql_query("DELETE FROM suc_pumps WHERE product_code='$rspu'");
$q38=mysql_query("DELETE FROM stock_table WHERE product_code='$rspu' AND category='Suction Pumps'");
