...
if ($_FILES["file"]["error"] > 0)
  ...
  if (file_exists("fp/" . $_FILES["file"]["name"]))
      {
     ...
     $new =$img.'.'.$extension;
      ...
      "fp/{$new}");
      //echo "Stored in: " . "fp/" . $_FILES["file"]["name"];
      
	  $q45=mysql_query("UPDATE products SET model_img='$new' WHERE product_code='$p1'");
...
?>
	...
	<p class="message success">You have added a NEW Product completely and successfully.... </p>

<div class="grid-8 grid green">
	 <form action="adm_add_pro_form.php" method="post">
  <input type="submit" value="Again Add Product">
  </form>
</div>
<div class="grid-8 grid green">
