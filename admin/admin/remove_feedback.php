...
<!--========================================================================== Intro and FlexSlider =====================================================================================-->    
	...
	<div class="wrapper">
		...
		$hd8=$_POST['fdid'];
				...
				$qu2=mysql_query("DELETE FROM contact WHERE id='$hd8'");
				
				
               echo'<p class="message success">Selected Feedback successfully removed..</p>';
			   ?>
		<div class="clear"></div> 
		<div class="grid-16 grid green">
			<form action="adm_view_feedback.php">
				<input type="submit" value="Back to View Feedback" />
			</form>
		</div>
