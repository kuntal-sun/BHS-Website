...
<!--========================================================================== Intro and FlexSlider =====================================================================================-->    
	...
	<div class="wrapper">
		...
		<div class="grid-16 grid grey">
 			<h4>Here You can ADD Stock of an Existing product as well as You can VIEW your Stock Stats... </h4>
 			
 		</div><br><br><br><br>
 		<div class="grid-5 grid green">
 			<form action="adm_manage_stock_form.php" method="post">
 			<label for="add_p" style="font-size: 15px;font-family: Verdana">Want to ADD Product Quantity???</label><br><br>
 			<input type="submit" value="Go" />
 			</form>
 		</div>
 		
 		<div class="grid-5 grid green">
 			<form action="adm_stock_chart_form.php" method="post">
 			<label for="rem_p" style="font-size: 15px;font-family: Verdana">Want to View Stock Chart???</label><br><br>
 			<input type="submit" value="Go" />
 			</form>
 		</div>
 		<div class="grid-5 grid green">
