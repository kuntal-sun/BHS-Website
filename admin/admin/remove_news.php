...
<!--========================================================================== Intro and FlexSlider =====================================================================================-->    
	...
	<div class="wrapper">
		...
		$hd5=$_POST['nwid'];
				...
				$qt5=mysql_query("DELETE FROM news WHERE id='$hd5'");
				
				
               echo'<p class="message success">Selected News successfully removed..</p>';
			   ?>
		<div class="clear"></div> 
		<div class="grid-16 grid green">
			<form action="adm_remove_news.php">
				<input type="submit" value="Back to View News" />
			</form>
		</div>
