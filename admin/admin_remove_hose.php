...
$rhp=$_POST['rhp_product']; 
$qw2=mysql_query("select * FROM products WHERE product_code='$rhp'");
$count=mysql_num_rows($qw2);
if ($count==1) {
	

$q42=mysql_query("DELETE FROM products WHERE product_code='$rhp' AND category='FUEL HOSE  PIPES'");
$q43=mysql_query("DELETE FROM hose_pipes WHERE product_code='$rhp'");
$q44=mysql_query("DELETE FROM stock_table WHERE product_code='$rhp' AND category='FUEL HOSE  PIPES'");
