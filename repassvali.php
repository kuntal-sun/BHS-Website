...
<!--========================================================================== Intro and FlexSlider =====================================================================================-->    
	...
	<div class="wrapper">
 		<div class="grid-6 grid">
 			<a href="log.php"><h4>Back to Account Section</h4></a>
                </div>
<div class="clear"></div>
...
include 'config.php';
if($_POST['opd']==$_SESSION['SESS_PASS']){
	$usr=$_SESSION['SESS_USER_ID'];
	$ops=$_POST['opd'];
	$nps=$_POST['npd'];
	$cps=$_POST['cnpd'];
  ...
  if($nps==$cps){
  $qi=mysql_query("UPDATE registered_users SET password='$nps'WHERE user_name='$usr' AND password='$ops'");
echo '<p class="message success">Password has been successfully changed</p>';
$_SESSION['SESS_PASS']=$nps;
 }
else{
echo'<div class="clear"></div>';	
echo '<p class="message warning">New Password and Confirmation Password Mismatch</p>';
echo '<div class="grid-6 grid">';
echo '<a href="password_change.php"><h4>Change Password</h4></a>';
echo '</div>';
}
}
else {
...
echo'<div class="clear"></div>';		
echo '<p class="message error">You have entered a WRONG! password..Please enter a valid one..</p>';
echo '<div class="grid-6 grid">';
echo '<a href="password_change.php"><h4>Change Password</h4></a>';
echo '</div>';
}
