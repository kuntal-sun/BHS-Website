...
<div class="container">
	<section id="content">
		<form action="repassvali.php" method="post">
			<h1>Change Password</h1>
			<div>
				<input type="password" placeholder="Old Password" name="opd"required="required" id="password" />
			</div>
			<div>
				<input type="password" placeholder="New Password" name="npd" required="required" id="password" />
			</div>
			<div>
				<input type="password" placeholder="Confirm New Password" name="cnpd" required="required" id="password" />
			</div>
			<div>
