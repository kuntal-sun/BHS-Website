 	...
 	<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
 		...
 		<tr>
 	      ...
 	      <label for="dob4">
 			...
 			<td>
 			<input type="date" id="datepicker" name="dob4" value="<?php echo $dob4;?>" required="required"/>
 			</td>
 		</tr>
...
$message.="http://localhost/bhswebsite/confirmation_shipping.php?passkey=$confirm_code";
...
if (PEAR::isError($mail)) {
	...
	echo '<div class="grid-4 grid">';
	echo '<p class="message success">Confirmation Link successfully sent!</p>';
    echo '</div>';
