...
echo"<script>setTimeout(\"location.href='http://localhost/bhswebsite/shipping_add.php';\",3000); </script>";
echo "Your account has been activated...You will be redirected to our your Shipping Page in a few seconds..Thank you for joining with us....BHS....HAVE A GREAT DAY!!";
}
